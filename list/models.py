...
class PostImage(models.Model):
    ...
    uploader_of_image = models.ForeignKey(User, on_delete=models.CASCADE, null=True)
    created_by = models.ForeignKey(Profile, on_delete=models.CASCADE, null=True, related_name='create_image')
    updated_by = models.ForeignKey(Profile, on_delete=models.CASCADE, null=True, related_name='update_image')
